...
struct episode {
    ...
    episode(int player_points, int dealer_points, int usable_ace, int reward) :
            player_points(player_points), dealer_points(dealer_points), usable_ace(usable_ace), reward(reward) {
    }
